...
function EditSquareIcon(props) {
  return (
    <svg width={20} height={20} fill="none" xmlns="http://www.w3.org/2000/svg" style={{ cursor: "pointer" }} {...props}>
      <path
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M12.901 3.219l4.186 4.185" stroke="#616162" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
