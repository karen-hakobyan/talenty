...
public class InheritanceAwarePartTreeMongoQuery extends PartTreeMongoQuery {
    ...
    public InheritanceAwarePartTreeMongoQuery(MongoQueryMethod method, MongoOperations mongoOperations, final ExpressionParser expressionParser, QueryMethodEvaluationContextProvider evaluationContextProvider) {
